...
(function($) {
	//追記：画面サイズを取得して代入
	W = $(window).width();
	//追記：IEだとピッタリにならないからIEだけマイナス
	if(!jQuery.support.opacity)W = W-20;
	...
	$.fn.panorama = function(options) {
		this.each(function(){ 
			var settings = {
				viewport_width: W,  //追記(元の値：600)
				speed: 10000,       //初期値:20000
				direction: 'left',
			...
			panoramaContainer.css('height', elemHeight+'px').wrap("<div class='panorama-viewport'></div>").parent().css('width',settings.viewport_width+'px')
